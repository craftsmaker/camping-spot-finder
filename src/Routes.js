...
function TabNavigator() {
  return (
    <Tab.Navigator
      swipeEnabled={false}
      tabBarOptions={{
        activeTintColor: "#FF7657",
        inactiveTintColor: "black",
        labelStyle: { textTransform: "capitalize" },
        indicatorStyle: { backgroundColor: "#FF7657" },
      }}
    >
      <Tab.Screen
        name="All"
        component={AllSpots}
        options={{ tabBarLabel: "All Spots" }}
        initialParams={{ type: "All" }}
      />
      <Tab.Screen
        name="Tenting"
        component={Tenting}
        options={{ tabBarLabel: "Tenting" }}
        initialParams={{ type: "Tenting" }}
      />
      <Tab.Screen
        name="RV Camping"
        component={RVCamping}
        options={{ tabBarLabel: "RV Camping" }}
        initialParams={{ type: "RV Camping" }}
      />
    </Tab.Navigator>
  );
}
